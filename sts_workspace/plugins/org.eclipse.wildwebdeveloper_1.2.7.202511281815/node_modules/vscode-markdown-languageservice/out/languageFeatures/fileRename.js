...
class MdFileRenameProvider {
    ...
    async #addDirectoryRenameEdits(edit, builder, token) {
        ...
        for (const [docUri, links] of allLinksInWorkspace) {
            for (const link of links) {
                ...
                if (link.source.hrefText.startsWith('..') && (0, path_1.isParentDir)(edit.newUri, docUri)) {
    ...
    #addLinkRenameEdit(doc, link, newUri, builder) {
        ...
        const newLinkText = (0, rename_1.getLinkRenameText)(this.#workspace, link.source, newFilePath, link.source.hrefText.startsWith('.'));
