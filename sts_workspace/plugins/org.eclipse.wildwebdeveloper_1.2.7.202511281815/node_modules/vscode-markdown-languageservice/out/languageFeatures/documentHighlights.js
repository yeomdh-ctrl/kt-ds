    ...
    *#getHighlightsForHeader(document, header, links, toc) {
        ...
        for (const link of links) {
            if (link.href.kind === documentLink_1.HrefKind.Internal
                ...
                yield {
                    range: (0, range_1.modifyRange)(link.source.hrefFragmentRange, (0, position_1.translatePosition)(link.source.hrefFragmentRange.start, { characterDelta: -1 })),
    ...
    #getHighlightsForLinkAtPosition(document, position, links, toc) {
        ...
        switch (link.href.kind) {
            ...
            case documentLink_1.HrefKind.Internal: {
                if (link.source.hrefFragmentRange && (0, range_1.rangeContains)(link.source.hrefFragmentRange, position)) {
