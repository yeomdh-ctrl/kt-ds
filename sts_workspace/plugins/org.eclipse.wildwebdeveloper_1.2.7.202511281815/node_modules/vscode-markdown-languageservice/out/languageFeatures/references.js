...
class MdReferencesProvider extends dispose_1.Disposable {
    ...
    async #getReferencesToLink(docLinks, sourceLink, triggerPosition, token) {
        ...
        const references = [];
        if (resolvedResource && this.#isMarkdownPath(resolvedResource) && sourceLink.href.fragment && sourceLink.source.hrefFragmentRange && (0, range_1.rangeContains)(sourceLink.source.hrefFragmentRange, triggerPosition)) {
    ...
    *#getReferencesToLinkReference(allLinks, refToFind, from) {
    ...
    #getPathRange(link) {
        return link.source.hrefFragmentRange
            ? (0, range_1.modifyRange)(link.source.hrefRange, undefined, (0, position_1.translatePosition)(link.source.hrefFragmentRange.start, { characterDelta: -1 }))
