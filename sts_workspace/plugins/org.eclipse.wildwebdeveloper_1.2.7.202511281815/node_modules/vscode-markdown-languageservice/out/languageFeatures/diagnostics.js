                    ...
                    if (fragmentLinks.length) {
                        ...
                        for (const link of fragmentLinks) {
                            ...
                            if (!(toc && tocLookupByLink(toc, link)) && !this.#isIgnoredLink(options, link.source.hrefPathText) && !this.#isIgnoredLink(options, link.source.hrefText)) {
                                const range = (link.source.hrefFragmentRange && (0, range_1.modifyRange)(link.source.hrefFragmentRange, (0, position_1.translatePosition)(link.source.hrefFragmentRange.start, { characterDelta: -1 }), undefined)) ?? link.source.hrefRange;
                                diagnostics.push({
...
function tocLookupByLink(toc, link) {
